...
class TaskAssignment(models.Model):
    ...
    assigned_to = models.ForeignKey(Employe_User, on_delete=models.CASCADE, related_name='assigned_tasks', default=1)  # Default to employee with ID 1
    ...
    def __str__(self):
        return f"{self.task.task_title} assigned to {self.assigned_to.first_name} {self.assigned_to.last_name}"
